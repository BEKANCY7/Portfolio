...
const RecentProjects = () => {
  return (
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-7-8 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
            className="sm:h-[41rem] h-[32rem] sm:w-[570px] lg:min-h-[32.5rem]  flex justify-center items-center w-[80vw]"
          >
            <PinContainer title={link} href={link}>
              <div className="relative flex items-center justify-center sm:w-[570px] sm:h-[40vh] h-[30vh] w-[80vw] overflow-hidden mb-10">
                ...
                <Image
                  ...
                  width={570}
                  height={400}
                  className="z-10 absoulte bottom-0"
                />
              </div>
